...
export const BasicNode = ({ node, updateFocusedIndex, isFocused, index, addNode, removeNodeByIndex, changeNodeValue }: BasicNodeProps) => {
  ...
  return (
    <div
      ...
      ref={nodeRef} contentEditable suppressContentEditableWarning>
